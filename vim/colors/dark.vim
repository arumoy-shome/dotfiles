...
hi Todo guibg=#100f10 guifg=#c0c530 ctermbg=0 ctermfg=11

hi Warning gui=none guibg=#d0bc00 guifg=#000000 cterm=none ctermbg=3 ctermfg=0
hi WarningMsg gui=none guibg=#d0bc00 guifg=#000000 cterm=none ctermbg=3 ctermfg=0
...
hi Exception gui=bold guifg=#d0bc00 cterm=bold ctermfg=2

hi Preproc gui=none guifg=#ef8b50 term=none cterm=none ctermfg=9
hi PreCondit gui=bold guifg=#ef8b50 cterm=bold ctermfg=9
hi Macro gui=bold guifg=#f78fe7 cterm=bold ctermfg=5
hi Include guifg=#ef8b50 ctermfg=9
hi Define guifg=#ef8b50 ctermfg=9
...
hi SpecialComment gui=bold guifg=#d3b55f cterm=bold ctermfg=3
...
hi Special gui=none guifg=#00c06f term=none cterm=none ctermfg=2
hi SpecialKey gui=none guibg=#191a1b guifg=#a8a8a8 cterm=none ctermbg=8 ctermfg=7
hi SpecialChar gui=bold guifg=#c0c530 cterm=bold ctermfg=11
...
hi Question gui=bold guifg=#c0c530 cterm=bold ctermfg=11
hi MoreMsg guifg=#70b900 ctermfg=10
hi ModeMsg gui=bold guifg=#44bc44 cterm=bold ctermfg=2

hi VimOption guifg=#4ae2f0 ctermfg=6
hi VimGroup guifg=#4ae2f0 ctermfg=5
...
hi SpellCap guibg=#d0bc00 guifg=#000000 ctermbg=3 ctermfg=0
...
if has('nvim')
  ...
  let g:terminal_color_9 = '#ef8b50'
  let g:terminal_color_10 = '#70b900'
  let g:terminal_color_11 = '#c0c530'
...
hi DiffText gui=bold guibg=#191a1b guifg=#ef8b50 cterm=bold ctermbg=8 ctermfg=1

hi diffAdded guifg=#44bc44 ctermfg=2
hi diffRemoved guifg=#ff8059 ctermfg=1
hi diffNewFile gui=none guifg=#2fafff ctermfg=4
hi diffFile gui=none guifg=#d0bc00 cterm=none ctermfg=3
...
hi NeomakeWarning gui=none guibg=#d0bc00 guifg=#000000 cterm=none ctermbg=3 ctermfg=0
hi NeomakeMessage gui=none guibg=#c0c530 guifg=#000000 cterm=none ctermbg=11 ctermfg=0

hi NeomakeVirtualtextInfoDefault guifg=#6ae4b9 ctermfg=14
hi NeomakeVirtualtextMessageDefault guifg=#c0c530 ctermfg=11
hi NeomakeVirtualtextWarningDefault guifg=#d0bc00 ctermfg=3
...
hi NeomakeStatColorTypeW gui=none guibg=#d0bc00 guifg=#000000 cterm=none ctermbg=3 ctermfg=0

" Markdown
" --------
hi MarkdownRule gui=bold guibg=#191a1b guifg=#70b900 cterm=bold ctermbg=8 ctermfg=10
...
hi MarkdownBold gui=bold guifg=#ef8b50 cterm=bold ctermfg=9
hi default link MarkdownBoldDelimiter MarkdownBold

hi MarkdownItalic gui=italic guifg=#d0bc00 cterm=none ctermfg=3
